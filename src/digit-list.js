    ...
    function DigitList() {
        ...
        var _round = function( maximumDigits ) {
            ...
            if (maximumDigits >= 0 && maximumDigits < this.count) {
                if (_shouldRoundUp.apply(this, [maximumDigits])) {
        ...
        var _isLongMIN_VALUE = function() {
            ...
            for (var i = 0; i < this.count; ++i) {
                if (this.digits[i] != LONG_MIN_REP[i]) return false;
            }
        ...
        this.getLong = function() {
            ...
            if ( _isLongMIN_VALUE.apply(this) ) {
        ...
        this.set = function( isNegative, s, maximumDigits, fixedPoint ) {
            ...
            if (fixedPoint) {
                ...
                if (-this.decimalAt > maximumDigits) {
                    ...
                    if (_shouldRoundUp.apply(this, [0])) {
                        this.count = 1;
                        ++this.decimalAt;
                        this.digits[0] = '1';
                    } else {
            ...
            // Eliminate digits beyond maximum digits to be displayed.
            // Round up if appropriate.
            _round.apply(this, [(fixedPoint ? (maximumDigits + this.decimalAt) : maximumDigits)]);
        };
    }
